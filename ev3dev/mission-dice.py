...
class Direction(Enum):
    ...
    """
    FORWARD = ['adelante', 'palante', 'avanza']
    BACKWARD = ['atras', 'retrocede', 'paratras', 'vuelve']
    LEFT = ['izquierda', 'a la izquierda','gira a la izquierda']
    RIGHT = ['derecha', 'a la derecha','gira a la derecha']
    STOP = ['para', 'frena', 'sooo']
...
class Command(Enum):
    ...
    These variations correspond to the skill slot values.
    """
    MOVE_CIRCLE = ['circulo', 'muevete en circulo']
    MOVE_SQUARE = ['cuadrado', 'muevete en cuadrado']
    SENTRY = ['centinela', 'modo centinela', 'firmes', 'activa modo centinela']
    PATROL = ['patrulla', 'modo patrulla']
    FIRE_ONE = ['disparo', 'un disparo', 'dispara']
    FIRE_ALL = ['dispara todo', 'dale con todo']
...
class MindstormsGadget(AlexaGadget):
    ...
    def on_custom_mindstorms_gadget_control(self, directive):
        ...
        try:
            ...
            print("Fáltan parámetros: {}".format(directive), file=sys.stderr)
    ...
    def _move(self, direction, duration: int, speed: int, is_blocking=False):
        ...
        """
        print("Comando movimiento: ({}, {}, {}, {})".format(direction, speed, duration, is_blocking), file=sys.stderr)
    ...
    def _activate(self, command, speed=50):
        ...
        """
        print("Comando activado: ({}, {})".format(command, speed), file=sys.stderr)
        ...
        if command in Command.SENTRY.value:
            ...
            self._send_event(EventName.SPEECH, {'speechOut': "Modo centinela activado"})
    ...
    def _proximity_thread(self):
        ...
        while True:
            while self.sentry_mode:
                ...
                if count > 3:
                    print("Límite proximidad alcanzado. Avisando a la Skill", file=sys.stderr)
    ...
    def _patrol_thread(self):
        ...
        while True:
            while self.patrol_mode:
                print("Modo patrulla activado, elige una ruta aleatoria", file=sys.stderr)
