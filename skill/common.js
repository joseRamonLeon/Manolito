...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Puedes saludarme... ¿Que puedo hacer por ti?';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = '¡Adios, Adeu, Agur!';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt("No te he entendido nada, prueba de nuevo anda...")
            .getResponse();
    }
};
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        ...
        const speakOutput = `Uhmmm, no se que quieres que haga realmente.. Inténtalo de nuevo`;
